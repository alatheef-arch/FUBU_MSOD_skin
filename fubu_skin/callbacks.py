...
# Note: All Dash objects (like dash, callback) and helper functions are 
# provided by the main app's execution scope when this code is loaded dynamically.
...
def register_callbacks():
    ...
    # These callbacks handle user actions within the tab after the data is loaded.
